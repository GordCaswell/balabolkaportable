...
user in an INI file next to BalabolkaPortable.exe called BalabolkaPortable.ini.
...
copy AppNamePortable.ini from this directory to BalabolkaPortable.ini next to
BalabolkaPortable.exe. The options in the INI file are as follows:
